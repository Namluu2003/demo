...
function Material() {
  ...
  const loadData = (currentPage, pageSize, searchValue, statusMaterial) => {
    request
      .get("/chatlieu", {
        params: {
          name: searchValue,
  ...
  const handleAdd = (data) => {
    confirm({
      title: "Xác nhận",
      icon: <ExclamationCircleFilled />,
      content: "Bạn có chắc muốn thêm chất liệu mới? ",
      okText: "Xác nhận",
      okType: "danger",
      cancelText: "Hủy",
      onOk() {
  ...
  const handleUpdate = (data) => {
    confirm({
      title: "Xác nhận",
      icon: <ExclamationCircleFilled />,
      content: "Bạn có chắc muốn cập nhật tên chất liệu? ",
      okText: "Xác nhận",
      okType: "danger",
      cancelText: "Hủy",
      onOk() {
        request
          .put(`/chatlieu/${item.id}`, data)
          .then((response) => {
            if (response.status === 200) {
              console.log(response);
      ...
      <div className="material-container">
          ...
          <Row gutter={10}>
            ...
            <Col span={8}>
              ...
              <Select
                defaultValue={null}
                style={{ width: "100%" }}
                onChange={(value) => setStatusMaterial(value)}
              >
        ...
        <div className="card p-3">
          <div className="d-flex justify-content-between align-items-center mb-2">
            <h6 className="fw-semibold">Bảng chất liệu</h6>
