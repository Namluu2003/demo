...
//         setIsVnpayPaid(
//             hasVnpayPayment &&
//             calculateTotalPayment >= (bill.totalMoney || 0) + (bill.moneyShip || 0)
//         );
//     } catch (error) {
//         console.error(error);
//         setIsVnpayPaid(false);
//     }
// };
...
//                 note: data.note,
//                 isCancel: isCancel,
//                 isVnpay: isVnpayPaid, // Pass isVnpay based on VNPAY payment status
//             },
//         })
//         .then(() => {
//             loadBill();
