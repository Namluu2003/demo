...
//     const fromDistrict = 1542; // Quận cố định của cửa hàng (theo OrderItem)
...
//           service_type_id: 3, // Theo OrderItem
//           to_district_id: toDistrict,
//           to_ward_code: String(selectedWard),
//           height: 11, // Giá trị mẫu, có thể tùy chỉnh
//           length: 28,
//           weight: 300,
//           width: 16,
//         },
...
//     const totalMoney = calculateTotalDone(listProducts); // Chỉ tính tiền hàng
//     const totalToPay =
//       totalMoney +
//       feeShip -
//       (percent / 100) * totalMoney;
...
//       totalMoney: totalMoney, // Không bao gồm phí ship
//       note: note,
...
//         const response = await axios.get(
//           baseUrl +
//             `api/vn-pay/payment?id=${tempNewBill.id}&total=${Math.floor(totalToPay)}`
//         );
//         if (response.status) {
...
//       calculateFee(); // Tính phí ship khi có đủ thông tin quận và phường
//     }
...
//           >
//             <img
//               src={item.image.split(",")[0] || "https://via.placeholder.com/150"}
//               className="h-[80px] w-[80px] object-contain mr-2"
//             />
//             <div className="flex flex-col justify-items-start">
//               <span className="text-sm text-black font-medium">{item.name}</span>
//               <span className="text-sm text-black font-medium">{item.sole}</span>
//             </div>
//           </th>
...
//             <button
//   className={`border-[1px] text-sm px-4 py-4 rounded flex items-center ${
...
//               <span className="text-gray-600 text-sm font-normal">Tổng tiền hàng</span>
...
//             <div></div>
//             <div className="w-[30%] flex items-center justify-between mx-5">
//               <span className="text-gray-600 text-sm font-normal">Phí vận chuyển</span>
//               <span className="text-red-500 text-sm font-medium">
...
//             <div></div>
//             <div className="w-[30%] flex items-center justify-between mx-5">
//               <span className="text-gray-600 text-sm font-normal">Voucher giảm giá</span>
//               <span className="text-red-500 text-sm font-medium">
//                 -
//                 {!!listProducts && percent > 0
//                   ? formatCurrency((percent / 100) * calculateTotalDone(listProducts))
//                   : formatCurrency(0)}
//               </span>
//             </div>
//           </div>
...
//             <div></div>
//             <div className="w-[30%] flex items-center justify-between mx-5">
//               <span className="text-gray-600 text-base font-medium">Tổng thanh toán</span>
...
//             <span>
//               Nhấn "Đặt Hàng" đồng nghĩa với việc bạn đồng ý với các điều khoản của YodaStore
//             </span>
//             <button
