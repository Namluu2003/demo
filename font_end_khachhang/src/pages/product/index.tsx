...
//   imgArr?: string[][];
// }) => {
//   // Select up to three images from imgArr (flatten the array and take first three)
//   const images = imgArr?.flat() || [];
//   const selectedImages = images.slice(0, 5); // Take up to three images
...
//             Giày Thể Thao Nam {inforShoe.name} đến từ thương hiệu<span className="ml-2 text-gray-600">{inforShoe.brand.name}</span> nổi tiếng tại Ý. Thiết kế giày basic, dễ ứng dụng, mang lại phong cách trẻ trung, năng động cùng chất liệu cao cấp mang lại sự thoải mái cho người sử dụng.
//           </p>
//           <div className="flex items-center mb-4">
//             <span className="font-semibold text-gray-700">Thương hiệu: </span>
//             <span className="ml-2 text-gray-600">{inforShoe.brand.name}</span>
//           </div>
//           <div className="flex items-center mb-4">
//             <span className="font-semibold text-gray-700">Danh mục: </span>
//             <span className="ml-2 text-gray-600">{inforShoe.category.name}</span>
//           </div>
...
//           </h2>
//                 Thiết Kế Giày Thể Thao Nam {inforShoe.name}
//               </h4>
//               <p className="text-gray-600 leading-relaxed">
//                 Giày Thể Thao Nam {inforShoe.name} được hoàn thiện từ 50% Polyester và 50% Polyurethane nên có độ bền cao. Form giày chuẩn đẹp với các đường chỉ vô cùng tinh tế, tỉ mỉ đến từng chi tiết. Kiểu dáng giày cổ thấp có dây buộc, ôm chân với điểm nhấn tên thương hiệu đặt tinh tế. Lớp lót giày được làm êm ái giúp chân luôn thoải mái dù mang giày suốt cả ngày. Phần đế giày có độ ma sát tốt cùng độ nâng phù hợp giúp đôi chân vững vàng hơn khi di chuyển và hoạt động.
//               </p>
//             </div>
//             {selectedImages[1] && (
...
//             </svg>
//             <span className="text-gray-600">
//               Thiết kế cổ thấp, dây buộc ôm chân, thoải mái cả ngày.
//             </span>
//           </li>
//           <li className="flex items-start">
//             <svg
...
//             </svg>
//             <span className="text-gray-600">
//               Đế giày chống trượt, nâng đỡ tốt khi vận động.
//             </span>
//           </li>
//           <li className="flex items-start">
//             <svg
